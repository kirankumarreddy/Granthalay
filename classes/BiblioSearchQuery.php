  ...
  function search($type, &$words, $page, $sortBy, $opacFlg=true) {
    ...
    if ((sizeof($words) == 0) || ($words[0] == "")) {
      ...
      if ($type == OBIB_SEARCH_BARCODE) {
        ...
        $criteria = $this->_getCriteria(array("biblio.topic1","biblio.topic2","biblio.topic3","biblio.topic4","biblio.topic5"),$words,$bField=true,$drop);
        ...
        $criteria = $this->_getCriteria(array("biblio.author","biblio.responsibility_stmt","biblio.title","biblio.title_remainder","biblio.topic1","biblio.topic2","biblio.topic3","biblio.topic4","biblio.topic5"),$words,$bField=true,$drop);
      } else {
